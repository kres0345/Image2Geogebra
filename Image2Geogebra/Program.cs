    ...
    class Program
    {
        static int Main(string[] args)
        {
            ...
            */
            ...
            //GenerateFile(Path.GetFileNameWithoutExtension(args[0]));
            return PackFile() == "" ? 1 : 0;
        }
        ...
        //private static List<string> geogebraData = new List<string>();
        ...
        static void AddPixel(int x, int y, int red, int green, int blue)
        {
